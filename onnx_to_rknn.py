...
if __name__ == '__main__':
    ...
    num_classes = 38
    input0_data = input0_data.reshape([3, 5+num_classes]+list(input0_data.shape[-2:]))
    input1_data = input1_data.reshape([3, 5+num_classes]+list(input1_data.shape[-2:]))
    input2_data = input2_data.reshape([3, 5+num_classes]+list(input2_data.shape[-2:]))
