...
def run(
    ...
    # im = torch.zeros((batch_size, 3, *imgsz)).to(device='cuda')
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / '/home/dedsecer/yolov5-master/data/Dataset/classes.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/home/dedsecer/yolov5-master/runs/train/exp13/weights/best.pt', help='model.pt path(s)')
