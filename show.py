...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            input0_data = input0_data.reshape([3, 43]+list(input0_data.shape[-2:]))
            input1_data = input1_data.reshape([3, 43]+list(input1_data.shape[-2:]))
            input2_data = input2_data.reshape([3, 43]+list(input2_data.shape[-2:]))
        ...
        # When everything done, release the capture and RKNN resources
        cap.release()
